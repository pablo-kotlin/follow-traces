...
import com.dogplace.project2.common.Constants.PATH_ADD_PLACE
...
class AddPlaceActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private suspend fun comprobarSiExiste(namePlace: String): Boolean = suspendCancellableCoroutine { continuation ->
        val token = Utils.getToken(this)
        val stringRequest = object : StringRequest(
