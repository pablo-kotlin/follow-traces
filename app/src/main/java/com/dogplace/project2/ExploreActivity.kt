...
import com.dogplace.project2.common.Constants.PATH_EXPLORE
import com.dogplace.project2.common.Constants.PATH_GET_COMMENT
import com.dogplace.project2.common.Utils.getBitmapDescriptor
import com.dogplace.project2.common.Utils.getToken
import com.dogplace.project2.common.Utils.parseUbicaciones
import com.dogplace.project2.common.Utils.saveComment
...
class ExploreActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun getUbicaciones(onSuccess: (List<Ubicacion>) -> Unit, onError: (VolleyError) -> Unit) {
        requestQueue = Volley.newRequestQueue(this)

        val token = getToken(this)
        val stringRequest = object : StringRequest(
            Method.POST, PATH_EXPLORE,
            { response ->
                try {
                    val jsonArray = JSONArray(response)
                    val ubicaciones = parseUbicaciones(jsonArray)
                    onSuccess(ubicaciones)
    ...
    private fun crearMarcadores() {
        for (ubicacion in listaUbicaciones) {
            ...
            val markerOptions = MarkerOptions()
                ...
                .icon(getBitmapDescriptor(this, iconResId))
            ...
            { response ->
                try {
                    ...
                    mBinding.tvLastComment.text = if (commentPlace.isEmpty()) {
                        ...
                        val italicText = "<i>No se ha escrito ninguna valoración por el momento.</i>"
    ...
    private fun showCommentDialog(nombreEstablecimiento: String) {
        ...
        btnDislikeCard.setOnCheckedChangeListener { buttonView, isChecked ->
            val newIcon = if (isChecked) R.drawable.ic_dislike_red_big else R.drawable.ic_dislike_big
            buttonView.setCompoundDrawablesWithIntrinsicBounds(newIcon, 0, 0, 0)
        ...
        btnAccept.setOnClickListener {
            ...
            saveComment(nombreEstablecimiento, comment, likeValue, dislikeValue, applicationContext)
